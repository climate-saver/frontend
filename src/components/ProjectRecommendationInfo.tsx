...
export default function ProjectRecommendationInfo({name, annualEnergySavings, totalInstallationCost, annualInstallationCost}: ProjectRecommendationInfoProps) {
  ...
  return (
    <Box sx={{width: '100%'}} pt={'8px'} pb={'8px'}>
      <Box sx={{fontWeight: 'bold', fontSize: '18px'}} mb={2} pl={'8px'} pr={'8px'}>{name}</Box>
      ...
      <Box sx={{borderRadius: '12px', backgroundColor: '#F3FFF8', padding: '16px'}} mb={2}>
        <Box sx={{fontWeight: 'bold', color: '#656363', fontSize: '12px'}} mb={1}>
          With a reduction in CO2 emissions equal to
        </Box>
        <Box sx={{fontWeight: 'bold', color: '#2B6744', fontSize: '18px'}}>
          1,000 gals of gas / year
        </Box>
      </Box>
      <Box sx={{borderRadius: '12px', backgroundColor: '#FEFEFE', padding: '16px'}}>
        <Box sx={{display: 'flex'}} mb={2}>
          ...
          <Box sx={{color: '#2B6744', fontSize: '12px', width: '25%'}}>
            ${annualEnergySavings}
          </Box>
        </Box>
        <Box sx={{display: 'flex'}} mb={2}>
